...
**Status:** Contained / No credential loss / Infrastructure still active (unresolved at platform level)
...
Spearphishing Link (T1566.002) + Spearphishing Voice (T1566.004) → Adversary-in-the-Middle credential capture (T1557) via BitB → intended MFA interception (T1111). Full mapping in [`attck-mapping.md`](./attck-mapping.md).
...
4. Publish IOCs to relevant community channels (Dota 2) — the recruitment vector is still active
